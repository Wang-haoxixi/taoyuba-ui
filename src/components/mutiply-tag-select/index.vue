<template>
  <div>
    ...
    <form-dialog :title="`选择${options.name}`" :dialogShow="dialogShow" @close="closeDialog">
      <multiply-table :selectIds="submitSelectedIds" :selectedList="selectedList" :columnMap="columnMap" :getRequestName="options.getRequestName" @giveSelectedObjs="handleChangeSelectedIds"></multiply-table>
    </form-dialog>
  </div>
</template>
