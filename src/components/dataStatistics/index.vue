        ...
        <div class="select-wrapper">
          <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item style="width: 120px;" v-show="levelShow">
              <el-select v-model="villageId" placeholder="基层组织" clearable @change="onChangeLevel">
                <el-option
            ...
            <el-form-item style="width: 120px;">
              <el-select :disabled="positionDisabled" v-model="positionId" placeholder="职务船员" clearable @change="onChangePositionId">
                <el-option
    ...
    getOrgList (id) {
      getVillage({id, page: 100}).then(({ data }) => {
        ...
        //   this.levelList = [{villageName: '全部', userId: ''}]
          this.levelList = data.data.records
        }
      })
    },
    getOrgInfo (data, id) {
