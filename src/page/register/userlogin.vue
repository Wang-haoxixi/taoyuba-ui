<template>
  <el-form class="login-form" status-icon :rules="rules" ref="form" :model="form" label-width="0">
    ...
    <el-form-item>
      ...
      <el-dialog title="免责声明" :visible.sync="dialogVisible" width="70%" :before-close="handleClose">
        <span>本网站是一个旨以提供渔船及配件交易服务、渔需渔获供销服务、渔业船员服务、渔业管理服务为一体的公共服务平台，不适宜发表政治实事、危害国家安全、破坏民族团结、破坏国家宗教政策、破坏社会稳定、侮辱、诽谤、教唆、淫秽等内容的作品。我们有权检查并删除任何不恰当、违法、侵害、中伤、胁迫以及违反条款的其它内容、信息、图片或资料。
        ...
        本网站所提供的信息，只供参考之用。本网站不保证信息的准确性、有效性、及时性和完整性。本网站及其雇员一概毋须以任何方式就任何信息传递或传送的失误、不准确或错误，对用户或任何其他人士负任何直接或间接责任。在法律允许的范围内，本网站在此声明，不承担用户或任何人士就使用或未能使用本网站所提供的信息或任何链接所引致的任何直接、间接、附带、从属、特殊、惩罚性或惩戒性的损害赔偿。 </span>
