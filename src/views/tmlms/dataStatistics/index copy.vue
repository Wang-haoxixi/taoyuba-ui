        ...
        <div class="select-wrapper">
          <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item style="width: 120px;">
              <el-select style="padding:0" :disabled="positionDisabled" v-model="positionId" placeholder="职位船员" @change="onChangePositionId">
                <el-option
...
<style lang='scss' scoped>
  #statisrics{
    ...
    background: linear-gradient(180deg, #002DA5 0%, #06164A 100%);
    .select-wrap{
      position:absolute;
      top:40px;
      right: 170px;
    ...
    .chart-title{
      position: relative;
      background-image: url('/img/dataStatistics/pic-data-top1.png');
      ...
      &::before{
        ...
        width: 1404px;
        height: 72px;
        background-image: url('/img/dataStatistics/pic-data-top2.png');
        background-repeat: no-repeat;
      ...
      &::after{
        ...
        width: 24px;
        height: 13px;
        background-image: url('/img/dataStatistics/pic-data-top3.png');
        background-repeat: no-repeat;
