  ...
  <div class="agent-add">
    <basic-container>
        ...
        <div style="text-align:center">
          ...
          <el-button v-if="manager" @click="$router.push({name:'listcrewSyslog'})">返回</el-button>    
...
import { detailCrew } from '@/api/tmlms/boatMan'
...
export default {
  ...
  created () {
    ...
    async function getAll () {    
      ...
      data.shipName = this.$route.query.shipName
      // console.log('船员信息')
      // console.log(data)
      // // 拿到ID 同步获取地址和选中的地址
