  ...
  <div class="agent-add">
    <basic-container>
        ...
        <div style="text-align:center">
          ...
          <el-button v-if="manager" @click="$router.push({name:'listCrewregister'})">返回</el-button>    
...
import { saveCrew, 
//detailCrew, 
editCrew, uploadPic, getCrewData } from '@/api/tmlms/boatMan'
import { getCrewregisterDeatil } from '@/api/tmlms/crewregister'
...
export default {
  ...
  created () {
    ...
    async function getAll () {    
      // 异步获取ID
      let data = await getCrewregisterDeatil(this.$route.query.edit || this.$route.query.see || this.$route.query.idcard).then( res=>{
