      ...
      <div class="shipowner_title">
        ...
        <el-table
          ...
          <el-table-column label="操作" width="180">                        
            <template slot-scope="scope">                      
              <el-button type="text" icon="el-icon-view" size="mini" @click="handleView(scope.row.idcard)" v-if="manager">查看
              </el-button>
...
import { getCrewregisterList } from '@/api/tmlms/crewregister'                     
...
export default {
  ...
  methods: {
    ...
    // 查看
    handleView (val) {
      this.$router.push({path:`/crewRegister/detail/${val}`,query:{ see: val }})
    },
    // 编辑
    handleEdit (val) {
    ...
    // 获取列表数据
    getData () {      
      getCrewregisterList(this.params).then(res=>{
