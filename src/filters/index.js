...
// 到分
export function dateFormatToMinute (date) {
  if (!date) {
    return '无'
  }
...
// 自定义
export function dateFormatTo (date, format) {
  if (!date) {
    return '无'
  }
...
export function dateFormatLL (date) {
  if (!date) {
    return '无'
  }
  return moment(date).format('ll')
}
export function dateFormatLLLL (date) {
  if (!date) {
    return '无'
  }
  return moment(date).format('llll')
}
export function dateFormatSS (date) {
  if (!date) {
    return '无'
  }
  return moment(date).format('YYYY-MM-DD')
